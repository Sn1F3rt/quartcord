...
class DiscordOAuth2HttpClient(abc.ABC):
    ...
    This class is meant to be overridden by :py:class:`quartcord.DiscordOAuth2Session` and should not be
    used directly.
    ...
    async def request(
        ...
        quartcord.RateLimited
            Raises an instance of :py:class:`quartcord.RateLimited` if application is being rate limited by Discord.

...
class Guild(DiscordModelsBase):
    ...
    async def fetch_from_api(cls, cache=True):
        ...
        who belongs to these guilds then, the cached property :py:attr:`quartcord.User.guilds` is updated.
        ...
        list[quartcord.Guild, ...]
            List of instances of :py:class:`quartcord.Guild` to which this user belongs.

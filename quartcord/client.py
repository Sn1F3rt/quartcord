...
class DiscordOAuth2Session(_http.DiscordOAuth2HttpClient):
    ...
    This class inherits :py:class:`quartcord._http.DiscordOAuth2HttpClient` class.
    ...
    async def create_session(
        ...
        *,
        data: dict = None,
        prompt: bool = True,
        permissions: typing.Union[discord.Permissions, int] = 0,
        **params,
    ):
        ...
        data : dict, optional
            ...
            `:py:meth:quartcord.DiscordOAuth2Session.callback` to retrieve this data in your callback view.
    ...
    async def save_authorization_token(token: dict):
        ...
        you must also override :py:meth:`quartcord.DiscordOAuth2Session.get_authorization_token`.
    ...
    async def get_authorization_token() -> dict:
        ...
        previously by `:py:meth:`quartcord.DiscordOAuth2Session.save_authorization_token` from user's cookies.
    ...
    async def fetch_connections() -> list:
        ...
        -------
        list
            List of :py:class:`quartcord.models.UserConnection` objects.
    ...
    async def fetch_guilds(self, use_cache=True) -> list:
        ...
        -------
        list
            List of :py:class:`quartcord.models.Guild` objects.
